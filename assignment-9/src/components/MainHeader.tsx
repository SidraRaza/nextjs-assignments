    ...
    <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 border-b border-gray-600 py-4 shadow-lg">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center w-full sm:w-auto">
          ...
          {/* Icons */}
          <div className="flex gap-6 text-white text-2xl sm:hidden">
            ...
            <div className="relative cursor-pointer hover:text-indigo-400">
              <FiHeart />
              <div className="bg-indigo-500 rounded-full absolute top-0 right-0 w-[18px] h-[18px] text-[12px] text-white flex items-center justify-center translate-x-1 -translate-y-1 shadow-md">
                0
              </div>
            </div>
        ...
        {/* Search Bar */}
        <div className="w-full sm:w-[300px] md:w-[60%] relative mb-4 sm:mb-0 hidden sm:block">
          <input
        ...
        <div className="hidden sm:flex gap-6 text-white text-2xl">
          <BiUser className="cursor-pointer hover:text-indigo-400 transition duration-300" />
